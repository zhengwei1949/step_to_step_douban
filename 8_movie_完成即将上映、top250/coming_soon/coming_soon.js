(function(angular){
  ...
  // 3.创建控制器
  app.controller('coming_soonController', ['$scope','$http','$route','$routeParams','MyService',function($scope,$http,$route,$routeParams,MyService){
      ...
      MyService.jsonp('https://api.douban.com/v2/movie/coming_soon',
